...
if __name__ == "__main__":
    ...
    parser.add_argument('--preserve_ratio', default=0.3, type=float, help='preserve ratio of the model size')
    ...
    if args.dataset == "cifar10":
        pretrained_model_path = "resnet50.pt"

        # Load the model
        model = models.resnet50(pretrained=False)
        checkpoint = torch.load(pretrained_model_path)
        
        # Modify the final fully connected layer for CIFAR-10 classification
